...
#define FinancialStatementBalanceSheetTermsArray @[FinancialStatementTermAsset, FinancialStatementTermCurrentAsset, FinancialStatementTermCash, FinancialStatementTermCashEquivalent, FinancialStatementTermShortTermInvestment, FinancialStatementTermAccountsReceivable, FinancialStatementTermLongTermAsset, FinancialStatementTermInventory, FinancialStatementTermLongTermInvestment, FinancialStatementTermPropertyPlantAndEquipment, FinancialStatementTermGoodwill, FinancialStatementTermIntangibleAsset, FinancialStatementTermAmortization, FinancialStatementTermDepreciation, FinancialStatementTermDeferredAssetCharge, FinancialStatementTermLiability, FinancialStatementTermCurrentLiability, FinancialStatementTermAccountsPayable, FinancialStatementTermShortTermDebt, FinancialStatementTermLongTermDebt, FinancialStatementTermDeferredLiabilityChargeDefinition, FinancialStatementTermMinorityInterest, FinancialStatementTermNegativeGoodwill, FinancialStatementTermShareholdersEquity, FinancialStatementTermPreferredStock, FinancialStatementTermCommonStock, FinancialStatementTermRetainedEarnings, FinancialStatementTermTreasuryStock, FinancialStatementTermCapitalSurplus]
...
#define StockMarketTermCrash @"Cash"
...
#define FinancialDefinitionSourceNYSSCPATermsArray @[FinancialStatementCurrentAssetDefinition, FinancialStatementCashDefinition, FinancialStatementCashEquivalent, FinancialStatementShortTermInvestmentDefinition, FinancialStatementLongTermAssetDefinition, FinancialStatementInventoryDefinition, FinancialStatementLongTermInvestmentDefinition, FinancialStatementPropertyPlantAndEquipmentDefinition, FinancialStatementIntangibleAssetDefinition, FinancialStatementLiabilityDefinition, FinancialStatementShortTermDebtDefinition, FinancialStatementLongTermDebtDefinition, FinancialStatementPreferredStockDefinition, FinancialStatementTreasuryStockDefinition, FinancialStatementCapitalSurplusDefinition, FinancialStatementCostOfGoodsSoldDefinition, FinancialStatementOperatingExpenseDefinition, FinancialStatementResearchAndDevelopmentDefinition, FinancialStatementContinuingOperationsDefinition, FinancialStatementDiscontinuedOperationsDefinition, FinancialStatementAccountingChangeDefinition, FinancialStatementCapitalExpenditureDefinition, FinancialStatementCapitalExpenditureDefinition]
