...
// ------------ //
 ...
 /* Stock Market Terms */
//---------------------/
#define StockMarketTermBenchmark @"Benchmark"
...
//---------------------------/
#define StockMarketTermBenchmarkDefinition @"The performance of a predetermined set of securities, used for comparison purposes. Such sets may be based on published indexes."
